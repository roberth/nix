...
RootedPath ProvenanceObject::getPath()
{
...
ref<Object> ProvenanceEvaluator::evalFile(const RootedPath & path, const std::string & displayPath)
{
    return wrap(inner->evalFile(path, displayPath));
}

ref<Object> ProvenanceEvaluator::evalExpr(const std::string & expr, const RootedPath & basePath)
{
    return wrap(inner->evalExpr(expr, basePath));
}

ref<Object> ProvenanceEvaluator::evalExprLazy(const std::string & expr, const RootedPath & basePath)
{
