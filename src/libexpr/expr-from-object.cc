        ...
        return std::visit(
            [&](const auto & query) -> trace::ResultVariant {
                ...
                if constexpr (std::is_same_v<Q, trace::QueryApply>) {
                    ...
                    return trace::ResultType{objectTypeToStringExpr(resultObj->getType())};
                    ...
                    if constexpr (std::is_same_v<Q, trace::QueryGetType>) {
                        return trace::ResultType{objectTypeToStringExpr(obj->getType())};
                        ...
                        objects[childId] = child;
                        return trace::ResultType{objectTypeToStringExpr(child->getType())};
                ...
                PrimOp{
                    ...
                    .impl =
                        [objPtr, innerEval](EvalState & state, const PosIdx pos, Value ** args, Value & v) {
                            ...
                            AmbientRegisterLocalFn registerLocal =
                                [resolver](std::shared_ptr<Object> obj, const std::string & id) {
