...
{
    auto qr = queryFn(id, trace::QueryGetAttr{name, fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetAttrNames{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetString{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetStringWithContext{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetPath{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetBool{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetInt{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetFloat{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetListSize{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetType{fromOf(id)});
...
{
    auto qr = queryFn(id, trace::QueryGetFunctionInfo{fromOf(id)});
