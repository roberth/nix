...
public:
     ...
     */
    VirtualRootId allocVirtualRoot()
    {
        return VirtualRootId(nextVirtualRoot++);
    }
    ...
    logResult(ValueHandle valueNum, const R & result, const std::optional<QueryHash> & queryHash)
    {
