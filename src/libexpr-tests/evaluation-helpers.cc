...
TEST_F(EvaluatorHelpersTest, forceDerivation_ReturnsDerivationPath)
{
    auto expr = state.parseExprFromString(
        "derivation { name = \"test\"; system = \"x86_64-linux\"; builder = \"/bin/sh\"; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = { b = { c = \"deep\"; }; }; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = { b = \"value\"; }; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = \"string\"; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ foo = \"value\"; bar = \"other\"; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr =
        state.parseExprFromString("{ a = { b = { baz = \"value\"; bar = \"other\"; }; }; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = 1; b = 2; c = 3; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = { b = 42; }; c = 99; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = 1; b = 2; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = 1; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ abc = 1; abd = 2; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
...
{
    auto expr = state.parseExprFromString("{ a = { b = { c = 123; }; }; }", state.rootedPath("."));
    auto v = state.allocValue();
    state.eval(expr, *v);
    auto obj = state.toObjectCompat(*v);
